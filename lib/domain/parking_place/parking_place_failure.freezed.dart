...
part of 'parking_place_failure.dart';
...
/// @nodoc
class _$ParkingPlaceFailureTearOff {
  const _$ParkingPlaceFailureTearOff();
...
/// @nodoc
// ignore: unused_element
const $ParkingPlaceFailure = _$ParkingPlaceFailureTearOff();

/// @nodoc
mixin _$ParkingPlaceFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ParkingPlaceFailureCopyWith<$Res> {
  factory $ParkingPlaceFailureCopyWith(
          ParkingPlaceFailure value, $Res Function(ParkingPlaceFailure) then) =
      _$ParkingPlaceFailureCopyWithImpl<$Res>;
}

/// @nodoc
class _$ParkingPlaceFailureCopyWithImpl<$Res>
    implements $ParkingPlaceFailureCopyWith<$Res> {
  _$ParkingPlaceFailureCopyWithImpl(this._value, this._then);

  final ParkingPlaceFailure _value;
  // ignore: unused_field
  final $Res Function(ParkingPlaceFailure) _then;
}
...
class _$_Unexpected implements _Unexpected {
  ...
  @override
  String toString() {
    return 'ParkingPlaceFailure.unexpected()';
  }
...
class _$_InsufficientPermissions implements _InsufficientPermissions {
  ...
  @override
  String toString() {
    return 'ParkingPlaceFailure.insufficientPermissions()';
  }
