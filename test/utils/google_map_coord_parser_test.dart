...
void main() {
  test('returns proper values when given number has 6 fraction digits',
      () async {
  ...
  test(
      'returns proper values when given number has more than 6 fraction digits',
      () async {
  ...
  test(
      'returns proper values when given number has less than 6 fraction digits',
      () async {
